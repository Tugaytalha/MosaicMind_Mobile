...
class _SelectionState extends State<Selection> {
            ...
            child: Column(
              ...
              children: [
                Row(
                  ...
                  children: [
                    _buildRaspberry(
                        'Raspberry1', _status1, "raspberry_machine_1"),
                    _buildRaspberry(
                        'Raspberry2', _status2, "raspberry_machine_2"),
                  ],
                ),
                ...
                Row(
                  ...
                  children: [
                    _buildRaspberry(
                        'Raspberry3', _status3, "raspberry_machine_3"),
                    _buildRaspberry(
                        'Raspberry4', _status4, "raspberry_machine_4"),
                  ],
                ),
              ],
            ),
  ...
  Widget _buildRaspberry(String name, String status, String documentID) {
    return Column(
      children: [
        GestureDetector(
          onTap: () {
            onClickedRasbperry(documentID);
          },
          child: ClipRRect(
            borderRadius:
